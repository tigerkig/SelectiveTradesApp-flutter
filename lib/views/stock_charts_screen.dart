...
import 'package:selective_chat/views/moving_averages_screen.dart';
...
class _StockChartScreenState extends State<StockChartScreen> {
  ...
  double high = 0, low = 0, open = 0, close = 0, avg_volume = 0, change = 0, price = 0;
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getADX error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getADX response ${response.body.toString()}");
            if(status == "error"){
          ...
          print("StockChartScreen.getADX response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getADX exception error: ${e.toString()}");
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getChartData error getting request status ${e.toString()}");
            }
            print("StockChartScreen.getChartData response ${response.body.toString()}");
            if(status == "error"){
              showToast("An error occurred");
              setState(() {
                is_loading = false;
              ...
              double max_high = 0, max_low = double.maxFinite, avg_volume = 0;
              ...
              for(var i = 0; i<series.length; i++){
                ...
                double volume = double.parse(candle_data["volume"].toString());
                ...
                // print("stock_charts_screen.getCharts candle data is: high = ${candle.high}\n"
                //     " low = ${candle.low}\n"
                //     " open = ${candle.open}\n"
                //     " close = ${candle.close}\n"
              ...
              high = max_high;
              low = max_low;
              this.avg_volume = avg_volume/candle_list.length;
          ...
          print("StockChartScreen.getChartData response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getChartData exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getMacd error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getMacd response ${response.body.toString()}");
            if(status == "error"){
              ...
              //print("StockChartScreen.getMacd macd is ${macd.toString()}");
              await getSupertrend();
            }
          }
          else{
          ...
          print("StockChartScreen.getMacd response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getMacd exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
  ...
  Future<void> getPrice() async {
    ...
    if(is_connected){
      try{
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getPrice error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getPrice response ${response.body.toString()}");
            if(status == "error"){
        ...
        showToast("An error occurred");
        print("StockChartScreen.getPrice: exception occurred ${e.toString()}");
        setState(() {
          is_loading = false;
        });
      }
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getRSI error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getRSI response ${response.body.toString()}");
            if(status == "error"){
              ...
              //print("StockChartScreen.getRSI RSI is ${rsi.toString()}");
              await getMacd();
            }
          }
          else{
          ...
          print("StockChartScreen.getRSI response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getRSI exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getSuperTrend error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getSuperTrend response ${response.body.toString()}");
            if(status == "error"){
              ...
              //print("StockChartScreen.getSuperTrend supertrend is ${supertrend.toString()}");
              await getRVOL();
            }
          }
          else{
          ...
          print("StockChartScreen.getSuperTrend response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getSuperTrend exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getVWAP error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getVWAP response ${response.body.toString()}");
            if(status == "error"){
              ...
              // print("StockChartScreen.getVWAP vwap is ${vwap.toString()}");
              await getRSI();
            }
          }
          else{
          ...
          print("StockChartScreen.getVWAP response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getVWAP exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
        ...
        if(response.statusCode == 200){
          if(response.body.isNotEmpty){
            ...
            try{
              ...
              print("StockChartScreen.getRVOL error getting request status ${e.toString()}");
            }
            //print("StockChartScreen.getRVOL response ${response.body.toString()}");
            if(status == "error"){
              ...
              print("StockChartScreen.getRVOL rvol is ${rvol.toString()}");
            }
          }
          else{
            setState(() {
          ...
          print("StockChartScreen.getRVOL response error: ${response.statusCode}");
        }
      }
      catch(e){
        print("StockChartScreen.getRVOL exception error: ${e.toString()}");
        showToast("An error occurred");
        setState(() {
          is_loading = false;
        });
          ...
          children:[
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "Vol: ${avg_volume.toStringAsFixed(2)}",
                  style: primaryTextstyle(),
                ),
              ],
            ),
